/*****************************************************************************
 ...
 AUTHOR    :  Omid Vaziri
 COURSE    :  CST8234
 PURPOSE   :  Create an OpenGL particle effect
 OBJECTIVES:  Demonstrate memory management + linked lists
*****************************************************************************/
...
#define WINDOW_TITLE            "Particle Man"
#define DFLT_INIT_POS           0
#define DFLT_INIT_WINDOW_W      800
#define DFLT_INIT_WINDOW_H      800
#define ORTHO                   100         
#define DFLT_BKG                0.0
